<?php
    ...
    {
        ?>
            <form id="myForm" action="http://25.61.144.153/distribuidos/Bird_punk/views/ServerBD/BDmodificarInformacion.php" method="post">
    ...
    {
        header("Location: http://25.61.144.153/distribuidos/Bird_punk/views/Backend/modificarInformacion.php?&idu=".$idu."&control=1");
    }
