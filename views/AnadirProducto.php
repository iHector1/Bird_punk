                ...
                <ul class="navbar-nav mx-auto">
                    <?php
                        if(!($varsesion == null || $varsesion == '')){
                            echo " <a href='http://25.0.98.15/distribuidos/Bird_punk/views/Backend/Logout.php' class='navbar-button'> Cerrar Sesion</a>";
                        }
                    ?>
                </ul>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-3 p-2 rectangle">
                ...
                <div class="col-5 ml-4">
                    <form method="POST" action="http://25.0.98.15/distribuidos/Bird_punk/views/Backend/agregarArticulo.php" enctype="multipart/form-data">
                        <!-- Nombre -->
