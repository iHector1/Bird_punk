...
if($control == 0)
{
    header ('Location:http://25.68.231.36/distribuidos/Bird_punk/views/Backend/BCarrito/agregarCarrito.php?id='.$idArtculo."&cantidad=$stock&idu=$id_u");    
}
 
if($control == 2){
header ('Location:http://25.68.231.36/distribuidos/Bird_punk/views/Backend/BCarrito/Cantidades.php?id='.$id_c.'&idu='.$id_u);
}
if($control == 3){
                            ...
                            <div class=" mb-4 order-list shadow-sm">
                                <div class=" p-4">
                                    ...
                                    ?>
                                            ...
                                            <div class="media">
                                                <a href="#"> 
                                                    <img class="rounded d-block mr-4" src=http://25.68.231.36/distribuidos/Bird_punk/views/Imagenes/<?php echo $fila['imagen'];?> alt=""> 
                                                </a>
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <!--Datos del producto-->
                                                    <p class="text-white mb-3">Cantidad : <?php echo $fila['cantidad'];?> | <a href="http://25.68.231.36/distribuidos/Bird_punk/views/Backend/BCarrito/funcionesEliminar.php?id=<?php echo $fila['id'];?>&idc=<?php echo $id_c;?>&idu=<?php echo $id_u;?>" class="btn btn-outline-light icofont-trash text-danger" >Eliminar</a></p>
                                                    </p>
